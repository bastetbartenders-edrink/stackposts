...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 28-Maio-2023 às 07:27
...
--
-- Banco de dados: `u638681611_123`
--

-- --------------------------------------------------------

--
-- Estrutura da tabela `sp_accounts`
--
...
--
-- Estrutura da tabela `sp_captions`
--
...
--
-- Estrutura da tabela `sp_coinpayments_history`
--
...
--
-- Extraindo dados da tabela `sp_files`
--
...
--
-- Estrutura da tabela `sp_language`
--
...
--
-- Extraindo dados da tabela `sp_language`
--
...
--
-- Estrutura da tabela `sp_language_category`
--
...
--
-- Extraindo dados da tabela `sp_language_category`
--
...
--
-- Estrutura da tabela `sp_options`
--
...
--
-- Extraindo dados da tabela `sp_options`
--
...
(168, 'base_url', 'https://meuavatar.xyz'),
(169, 'beamer_status', '0'),
...
(284, 'license', ''),
(285, 'forgot_password_email_content', '&lt;p&gt;Ol&amp;aacute; {fullname}! &lt;br&gt;&lt;br&gt;Algu&amp;eacute;m (espero que voc&amp;ecirc;) solicitou uma nova senha para sua conta.&lt;br&gt;Nenhuma altera&amp;ccedil;&amp;atilde;o foi feita em sua conta ainda.&lt;/p&gt;\r\n&lt;p&gt;&lt;br&gt;Voc&amp;ecirc; pode mudar sua senha acessando este link:&amp;nbsp;&lt;br&gt;&lt;a href=&quot;https://www.app.bombermidia.com.br/{recovery_password_link}&quot; target=&quot;_blank&quot; rel=&quot;noopener&quot;&gt;{Recuperar Senha Agora}&lt;/a&gt;. &lt;br&gt;&lt;br&gt;Se voc&amp;ecirc; n&amp;atilde;o solicitou uma redefini&amp;ccedil;&amp;atilde;o de senha, nenhuma outra a&amp;ccedil;&amp;atilde;o ser&amp;aacute; necess&amp;aacute;ria.&lt;br&gt;&lt;br&gt;Obrigado,&lt;/p&gt;\r\n&lt;p&gt;&lt;strong&gt;Social Bomber&lt;/strong&gt;&lt;/p&gt;');

-- --------------------------------------------------------

--
-- Estrutura da tabela `sp_payment_history`
--
...
--
-- Estrutura da tabela `sp_payment_subscriptions`
--
...
--
-- Extraindo dados da tabela `sp_plans`
--
...
--
-- Estrutura da tabela `sp_proxies`
--
...
--
-- Estrutura da tabela `sp_purchases`
--
...
--
-- Extraindo dados da tabela `sp_purchases`
--

INSERT INTO `sp_purchases` (`id`, `ids`, `item_id`, `is_main`, `purchase_code`, `version`) VALUES
(3, '6448678fdc7c1', '21747459', 1, 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx', '8.0.3'),
...
--
-- Extraindo dados da tabela `sp_team`
--
...
--
-- Estrutura da tabela `sp_team_member`
--
...
--
-- Extraindo dados da tabela `sp_users`
--
...
(1, '6448678fb7c2f', NULL, 1, 1, 'admin', 'adminko', 'mail@gmail.com', '917df57211186a34e040d1ca4878c951', 1, 2145916800, 'America/Sao_Paulo', 'en', 'direct', 'https://ui-avatars.com/api/?name=Hi&background=0674ec&color=fff', '{\"is_subscription\":0,\"bill_owner\":\"\",\"bill_tax_number\":\"\",\"bill_address\":\"\"}', 2, 1685258812, NULL, 1681286037, 1681286037);

-- --------------------------------------------------------

--
-- Estrutura da tabela `sp_user_roles`
--
...
--
-- Índices para tabela `sp_accounts`
--
ALTER TABLE `sp_accounts`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `sp_blogs`
--
ALTER TABLE `sp_blogs`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `sp_captions`
--
ALTER TABLE `sp_captions`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `sp_coinpayments_history`
--
ALTER TABLE `sp_coinpayments_history`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `sp_faqs`
--
ALTER TABLE `sp_faqs`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `sp_files`
--
ALTER TABLE `sp_files`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `sp_groups`
--
ALTER TABLE `sp_groups`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `sp_language`
--
ALTER TABLE `sp_language`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `sp_language_category`
--
ALTER TABLE `sp_language_category`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `sp_options`
--
ALTER TABLE `sp_options`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `sp_payment_history`
--
ALTER TABLE `sp_payment_history`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `sp_payment_subscriptions`
--
ALTER TABLE `sp_payment_subscriptions`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `sp_plans`
--
ALTER TABLE `sp_plans`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `sp_posts`
--
ALTER TABLE `sp_posts`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `sp_proxies`
--
ALTER TABLE `sp_proxies`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `sp_purchases`
--
ALTER TABLE `sp_purchases`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `sp_smtp`
--
ALTER TABLE `sp_smtp`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `sp_team`
--
ALTER TABLE `sp_team`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `sp_team_member`
--
ALTER TABLE `sp_team_member`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `sp_users`
--
ALTER TABLE `sp_users`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `sp_user_roles`
--
...
--
-- AUTO_INCREMENT de tabela `sp_accounts`
--
ALTER TABLE `sp_accounts`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT de tabela `sp_blogs`
--
ALTER TABLE `sp_blogs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de tabela `sp_captions`
--
ALTER TABLE `sp_captions`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `sp_coinpayments_history`
--
ALTER TABLE `sp_coinpayments_history`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `sp_faqs`
--
ALTER TABLE `sp_faqs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `sp_files`
--
ALTER TABLE `sp_files`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;

--
-- AUTO_INCREMENT de tabela `sp_groups`
--
ALTER TABLE `sp_groups`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `sp_language`
--
ALTER TABLE `sp_language`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13268;

--
-- AUTO_INCREMENT de tabela `sp_language_category`
--
ALTER TABLE `sp_language_category`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de tabela `sp_options`
--
ALTER TABLE `sp_options`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=286;

--
-- AUTO_INCREMENT de tabela `sp_payment_history`
--
ALTER TABLE `sp_payment_history`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT de tabela `sp_payment_subscriptions`
--
ALTER TABLE `sp_payment_subscriptions`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de tabela `sp_plans`
--
ALTER TABLE `sp_plans`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;

--
-- AUTO_INCREMENT de tabela `sp_posts`
--
ALTER TABLE `sp_posts`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;

--
-- AUTO_INCREMENT de tabela `sp_proxies`
--
ALTER TABLE `sp_proxies`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de tabela `sp_purchases`
--
ALTER TABLE `sp_purchases`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de tabela `sp_smtp`
--
ALTER TABLE `sp_smtp`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de tabela `sp_team`
--
ALTER TABLE `sp_team`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de tabela `sp_team_member`
--
ALTER TABLE `sp_team_member`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `sp_users`
--
ALTER TABLE `sp_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de tabela `sp_user_roles`
--
ALTER TABLE `sp_user_roles`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
COMMIT;
